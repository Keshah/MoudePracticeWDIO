...
class ProfilePage extends BasePage {
    get btnCustomerMenu() { return $('button[data-action="customer-menu-toggle"]'); }
    get linkMyAccount() { return $('//a[text()="My Account"]'); }
    get linkEditProfile() { return $('a[href="https://www.htfr.com/customer/account/edit/"]'); }
    get inputFirstname() { return $('input[name="firstname"]'); }
    get btnSave() { return $("button[title='Save']"); }
